...
{
    ht_insert(ht,"vrsn",GAS_API_GET_DLL_VERSION,"GAS_API_GET_DLL_VERSION");
    ht_insert(ht,"strtrcrd",GAS_API_START_RECORD,"GAS_API_START_RECORD");
    ht_insert(ht,"stprcrd",GAS_API_STOP_RECORD,"GAS_API_STOP_RECORD");
    ht_insert(ht,"strtstrmng",GAS_API_START_STREAMING,"GAS_API_GET_DLL_VERSION");
    ht_insert(ht,"stpstrmng",GAS_API_STOP_STREAMING,"GAS_API_START_STREAMING");
    ht_insert(ht,"dsnpsht",GAS_API_DO_SNAPSHOT,"GAS_API_STOP_STREAMING");
    ht_insert(ht,"gtvdsttstc",GAS_API_GET_DLL_VERSION,"GAS_API_DO_SNAPSHOT");
    ht_insert(ht,"vrsn",GAS_API_GET_VIDEO_STATISTIC,"GAS_API_GET_VIDEO_STATISTIC");
    ht_insert(ht,"gtstts",GAS_API_GET_STATUS,"GAS_API_GET_STATUS");
    print_table(ht);
}
